export const data = [
	{
	  ...
	  relatedWords: [
		{
		  id: 1,
		  name: "Adashib yo'lga chiqqan bulut",
		  description: "adashib yo'lga chiqqan  bulut– the lost cloud ",
		  title:
			"Tong bo‘zarib yorishdi. Yolg‘on tongda adashib yo‘lga chiqqan bulutlar taraldi.  ",
		  text: "(Shuhrat, Shinelli yillar)",
		},
		{
		  id: 2,
		  name: "Aldamchi bulut",
		  description: "aldamchi bulutlar- clouds of illusion",
		  title:
			"Zaynab muhabbatning aldamchi bulutlari ustida suzib yurganida o‘zining bo‘lajak to‘yini xayol ko‘zi bilan ko‘rardi.",
		  text: "(T. Malik, Shaytanat, 1)",
		},
		{
		  id: 3,
		  name: "Badbo'y bulut",
		  description: "badbo'y bulutlar– foul clouds",
		  title:
			"Vatanimizning zangori osmonini badbo‘y bulutlar qoplagan og‘ir sinov daqiqalarida ham uning [G‘afur G‘ulomning] baland na'rasi uzoq-uzoqlarga eshitilib turdi",
		  text: "( Gazetadan) ",
		},
		{
		  id: 4,
		  name: "Badjahl bulut",
		  description: "badjahl bulutlar – furious cloud",
		  title:
			"Quyuq, bahaybat, badjahl bulutlardan yirik yomg‘ir tomchilari savalab turardi",
		  text: "( Oybek, Quyosh qoraymas)	",
		},
		{
		  id: 5,
		  name: "Badqovoq bulut",
		  description: "badqovoq bulutlar – fierce clouds",
		  title:
			"Tashqariga chiqib, ko‘ngli yanayam yorishib uzoq ketdi: badqovoq kulrang bulutlar uzoqlarga chekingan. ",
		  text: "(A. Obidjon, Akang qarag‘ay Gulmat )",
		},
		{
		  id: 6,
		  name: "Baxmal bulut",
		  description: "baxmal bulutlar - velvet clouds",
		  title: "Dengizlar ko’karib tortadi chilim, Baxmal bulutlarni kiyayotgan sen. ",
		  text: "(Eshqobil Shukur, Hamal Ayvon”)",
		},
  
		{
		  id: 7,
		  name: "Baqiroq bulut",
		  description: "baqiroq bulutlar-screaming clouds",
		  title: "Baqiroq bulutlar qanday yaxshi! Sharillatib yomg‘ir yog‘ib yubordi. ",
		  text: "(Mirmuhsin, Umid)",
		},
  
		{
		  id: 8,
		  name: "Bir savam paxtaday bulut",
		  description: "bir savam paxtaday bulut- cotton-like cloud (cumulus clouds)",
		  title:
			"Huv anavi, bir savam paxtaday oppoq bulut parchasi qirralariga shafaq aksi urib turibdi. ",
		  text: "(J . Abdullaxonov, To‘fon) ",
		},
		{
		  id: 9,
		  name: "Daydi bulut",
		  description: "daydi bulut – fugitive cloud",
		  title:
			"Quyosh dumalab, ko‘kka ko‘tarilar, daydi bulut parchalarining ko‘lankasi qishloq ustidan o‘tib turardi.",
		  text: "( Sh. Toshmatov, Erk qushi)",
		},
		{
		  id: 10,
		  name: "Erinchoq bulut",
		  description: "erinchoq bulutlar-idle clouds",
		  title:
			"Osmonda iliq bahor quyoshi, oppoq, erinchoq bulutlar....",
		  text: "( O‘. Hoshimov, Sevgi qissalari)",
		},
		{
		  id: 11,
		  name: "Hurpaygan bulut",
		  description: "hurpaygan bulutlar – shaggy cloud",
		  title:
			"Hurpaygan bulut osilib turaverdi-yu, yomg‘ir yog‘madi.",
		  text: " (A. Muxtor, Opa - singillar) ",
		},
		{
		  id: 12,
		  name: " Ipak bulut",
		  description: "ipak bulutlar- silk clouds",
		  title:
			"Adirlar egnida yam-yashil qabo, Shamol halinchakda ipak bulutlar...",
		  text: "(Eshqobil Shukur, Hamal Ayvoni)",
		},
		{
		  id: 13,
		  name: "Janda bulut",
		  description:
			"janda bulutlar -ragged clouds",
		  title:
			"Yurakning ichida mung’ayib, g‘amli... Janda bulutlarga o‘rab oyog’im, Qora suyaklarin qalayman shomning Shafaq o‘chog‘iga o‘tinday tag‘in... ",
		  text: "(Eshqobil Shukur, Hamal Ayvoni)",
		},
		{
		  id: 14,
		  name: "Kimxob parchasidek bulut",
		  description: "kimxob parchasidek bulut - brocade-like clouds",
		  title:
			"Tuman orasiga o‘ralgan cho‘qqining uchi qilich damidek yarqirab ketdi-yu, bir dam kimxob parchasidek bulut 	yalt-yalt yonib, ko‘zni qamashtirdi.",
		  text: " (S. Ahmad, Yo‘lda.) ",
		},
		{
		  id: 15,
		  name: "Kulrang bulut",
		  description: "kulrang bulutlar – gray clouds",
		  title:
			"Hamma yoqni oppoq qor qoplagan, havoni kulrang bulut chodiri to‘sib olgan bir kun edi. Ammo havo rutubatli, zax osmonda xo‘mraygan kulrang bulutlar muallaq turib qolgan.",
		  text: "( P. Tursun, O‘qituvchi)( O‘. Hoshimov, Sevgi qissalari)",
		},
		{
		  id: 16,
		  name: "Kumush rangli bulut",
		  description: "kumush bulutlar – silver clouds",
		  title:
			"Yosh burgut uchmoqda ko‘kda shiddatkor, Kumush bulutlarning to‘zg‘itib  parin ",
		  text: "(A. Oripov, Yillar armoni)",
		},
		{
		  id: 17,
		  name: "Kumush bulut",
		  description: "kumush rangli bulutlar -  silvery clouds",
		  title:
			" Kumush rangli bulutlar,Suv oladi Oroldan.Lolazorga aylanar Sohil erta bahordan.  	",
		  text: " (3. Diyor) ",
		},
		{
		  id: 18,
		  name: "Kuz buluti",
		  description: "kuz buluti- autumn cloud",
		  title:
			"Oy havolab ketgan, qatlam-qatlam kuz bulutlari ohista suzib o‘tar, namxush tuproq isi anqir edi.",
		  text: " (O‘. Hoshimov, Sevgi qissalari)",
		},
		{
		  id: 19,
		  name: "Ko’k bulut",
		  description: "ko’k bulutlar- blue clouds",
		  title:
			"Ikki dilga ikki uya qo’ygan qaldirg’och Ko‘k bulutlar yo’rgaklaydi faryodlaringni. (Eshqobil Shukur, Hamal Ayvon)",
		  text: "Sho’r boshing yopinar ko‘k bulut. Tegrangda shamollar tizilar.(Eshqobil Shukur, Hamal Ayvoni)  ",
		},
		{
		  id: 20,
		  name: "Mag’zavadek kir bulut",
		  description: "mag‘zavadek kir bulutlar -dirty clouds	",
		  title:
			"Peshindan keyin osmonni mag‘zavadek kir bulutlar qopladi.",
		  text: " (O‘. Hoshimov, Tushda kechgan umrlar)",
		},
		{
		  id: 21,
		  name: "Momiq bulut",
		  description: "momiq bulutlar - fluffy cloud",
		  title:
			"Ular [samolyotlar].. orqasidan  to‘zonli iz qoldirib, o‘qday uchib borar, momiq bulutlarning patini to‘zitib,olg‘a parvoz etar, ammo ovozi eshitilmas edi. (O‘. Hoshimov, Qalbingga quloq sol)",
		  text: " Osmon tiniq, odamning quchoqlab olgisi keladigan oppoq momiq bulutlar onda- sonda ohista suzib o’tar, ularning soyasi adirlar ustida sekin-sekin sudralib boradi. ( O‘. Hoshimov, Sevgi qissalari) ",
		},
		{
		  id: 22,
		  name: "Motam libosini kiygan bulut",
		  description: "motam libosini kiygan bulutlar- clouds in mourning dress",
		  title:
		...
		},
		{
		  id: 23,
		  name: "Nimqora bulut",
		  description: " nimqora bulutlar- blackish clouds",
		  title: "Nimqora bulutlar ko’kka berkindi- Qaldirg’ochlar asta yoydilar quloch.",
		  text: " (Xosiyat Rustamova, Devor)",
		},
		
		{
		  id: 24,
		  name: "Olachalpoq bulut",
		  description: "olachalpoq bulutlar – scattered clouds",
		  title: "Ufqdagi olachalpoq bulutlar qirmizi rangga kirdi, dengiz qorayib, surmarang tus ola boshladi.",
		  text: "(Yoshlik)",
		},
		{
		  id: 25,
		  name: "Oppoq bulut",
		  description: "oppoq bulutlar– snow white clouds	",
		  title:
			"Oppoq bulut kiyib o‘tdi marhumlar...Qo‘limda hamyon-u, egnimda jubba. (Eshqobil Shukur, Hamal Ayvoni)",
		  text: "  Osmonda oppoq bulutlardan uzilib tushgan ipak tasmadek mezon to‘rlari suzadi. ( S. Nurov, Narvon)",
		},
		{
		  id: 26,
		  name: " Oq bulut",
		  description:
			" oq bulut– white cloud",
		  title:
			"Yig‘lagim keladi jimgina Bir uyum oq bulut poyida Hudhudlar qanoti — zardevollarning Oq bulutlar cho’kkan xilvatgohida. (Eshqobil Shukur, Hamal Ayvoni)",
		  text: " Siyrak oq bulut orqali xiralanib ko‘ringan quyosh g‘arbga qarab yumalay boshlagan bir paytda otliqlar qishloqqa kirib kelib, o‘zlarini o‘rab olgan odamlardan oqsoqolni so‘radilar. (P. Tursun, O‘qituvchi)\n Aylanayin, tug‘ishgan Yer, qanot ber, oqqush bo‘lay Hech bo‘lmasa yengilgina suzib yurgan oq bulut.  (Halima Xudoyberdieva, Saylanma)	",
		},
		{
		  id: 27,
		  name: "Oqish bulut",
		  description:
			" oqish  bulutlar– milky clouds",
		  title:
			"Oftob hali qor tashlagan suyuq, oqish bulutlar ortidan chiqmagan 	bo‘lsa ham, tushga borib, hamma yoq ilib ketdi. ",
		  text: " (P.Qodirov, Uch ildiz) 	",
		},
		{
		  id: 28,
		  name: " Palaxsa-palaxsa bulut",
		  description:
			"palaxsa-palaxsa bulutlar - clustering cloud 	",
		  title:
			"Ana, ko‘kka tutashgan cho‘qqilarni 	palaxsa -palaxsa 	bulutlar qoplab, butun olam kulrang pardaga o‘ralganday bo‘ldi. ",
		  text: "(H.Nazir, So‘nmas chaqmoqpar)",
		},
		{
		  id: 29,
		  name: " Par bulut",
		  description: " par bulutlar – soft clouds",
		  title:
			"Par bulutlar, marvarid qorlar  Yuksak cho‘qqi uzra qo‘ygan bosh.",
		  text: "Par bulutlar, marvarid qorlar  Yuksak cho‘qqi uzra qo‘ygan bosh.",
		},
		{
		  id: 30,
		  name: "Parqu bulut,",
		  description: "parqu bulutlar- feathered clouds",
		  title:
			"Parhu bulutlarning Oppqk yonidan, Uchar galamlarda Qilaman parvoz. (Usmon A’zim, Saylanma)  ",
		  text: "Shunday kezlarda u sahnaga yurib emas, go‘yo parqu bulutlar ustida suzib chiqar edi. (T. Malik. Shaytanat, 1) ",
		}, 
		{
		  id: 31,
		  name: "Parcha bulut",
		  description: "parcha  bulut- pillowy cloud",
		  title: "Uchrashinglar oydin makonda, Bahor kabi yashaganlar kulib...Hozircha men yozgi osmonda Qovjiragan bir parcha bulut.  (Usmon A’zim, Saylanma)",
		  text: "Ketasan. Osmonning kungurasida Na parcha bulutu, na bir tutam dud. (Usmon A’zim, Saylanma)",
		},
		{
		  id: 32,
		  name: " Past tushgan bulut",
		  description: "past tushgan bulut-low down clouds",
		  title: "Ertalab havo tund, osmonni  past tushgan bulutlar qoplab olgan. ",
		  text: "(Sh.Xolmirzaev, Bodom qishda gulladi)",
		},
		{
		  id: 33,
		  name: " Pastak bulut",
		  description: " pastak bulutlar- low clouds ",
		  title:
			"Zulmat quyuqlashib borar, pastak bulutlar qop-qora etaklarini sudrab, shahar ustida kezib yurar, hamon o‘sha sovuq, loqayd tomchilarini purkar edi.",
		  text: "(O’. Hoshimov, Qalbingga quloq sol)",
		},
		{
		  id: 34,
		  name: "Pag'a bulut",
		  description: "pag'a (pag'a-pag'a) bulut   – downy clouds ",
		  title:
			"Ko‘k yuzida pag‘a bulut, oq bulut…  Bir qarasang — osmon to‘la oqquvlar.  (Mirtemir)",
		  text: "Tog‘ tomonidan ko‘tarilib, quyosh betini qoplab turgan bir pag‘a bulut cho‘kkanda, tiktepa yerlari nur ichiga cho‘mib ko‘rinadi. (A. Qodiriy, Obid ketmon)	 ",
		},
		{
		  id: 35,
		  name: "Pag'a bulut",
		...
		{
		  id: 36,
		  name: " Pushti rang bulut",
		  description: "pushti rang bulut-pink clouds",
		  title:
			"Qoramtir, qo‘ng‘ir, pushti bulut karvonlari 	go‘yo qizil shu'la 	tobidansharqqa shoshilib qochar edi. (P. Tursun, O‘qituvchi) ",
		  text: "Tiniq moviy osmonda parcha-parcha 	oq, pushtirang bulutlar sokin suzadi. (N.Aminov, Yolg‘onchi)	",
		},
		{
		  id: 37,
		  name: " Qalin bulut",
		  description: "qalin  bulut– dense, puffy clouds",
		  title:
			"Qalin, qora bulut yana bitta-bitta sovuq uchqun tashlab, hamma yoqni qoplab olgan. ",
		  text: "(O‘. Hoshimov, Ikki surat) 	",
		},
		{
		  id: 38,
		  name: " Qat-qat bulut",
		  description: "qat-qat bulut",
		  title:
			"Ko’kka boqdim, o’t tutashdi jonim aro... Qat-qat bulut qatlarida ne sir-asror! (Usmon A’zim, Saylanma)",
		  text: " Havoga yelpig‘ichday qat-qat bulutlar chiqdi.  ( O‘. Hoshimov, Sevgi qissalari)",
		},
		{
		  id: 39,
		  name: "Qatlamli bulut",
		  description:
			" qatlamli bulut – layered clouds",
		  title:
			"Qatlamli bulutlar. (O‘zbek tilining izohli lug‘ati, 5-jild)",
		  text: "Havoga yelpig‘ichday qat-qat bulutlar chiqdi.  ( O‘. Hoshimov, Sevgi qissalari)",
		},
		{
			id: 40,
			name: "Qittay bulut",
			description: " qittay bulut - a bit of a cloud ",
			title:
			  "Osmon tiniq, ko‘m-ko‘k shishaday",
			text: " Qittay bulut yo‘q.( H.Olimjon)",
		  },
		  {
			id: 41,
			name: "Qizil bulut",
			description:
			  " qizil bulut– red clouds ",
			title:
			  "Qizil bulutlar endi sarg‘imtir tusga kirib, ko‘z oldimda rangini o‘zgartiraverdida, birdan sinkaga solgandek zangori rangga bo‘yaldi, — dedi chol.   ",
			text: "(S. Ahmad, Cho‘l burguti)",
		  },
		  {
			id: 42,
			name: "Qonli bulut",
			description: " qonli bulutlar– bloody clouds",
			title: "Har holda, Toshkent ustiga yana qonli bulutlar chiqdi, ishning oxiri nima bilan tinchlanar, bu bir xudogagina ma'lumdir. ",
			text: "(A.	Qodiriy, O‘tgan kunlar) ",
		  },
		  {
			id: 43,
			name: "Qop-qora bulut ",
			description: " qop-qora bulut– sombre clouds ",
			title:
			  "Bo’g’zimga bahaybat qayg’u tiqildi.Ko‘zimga yiqildi  qop-qora bulut.(Usmon A’zim, Saylanma)   ",
			text: "O‘n beshimda bir tun qop-qora bulut Meni poymol qildi, men qolmadim but, Nikoh to‘shagimga nechun qo‘yib o‘t, Nechun elni buzib chinqirmadim-a?  (Halima Xudoyberdieva, Saylanma)",
		  },
		  {
			id: 44,
			name: "Qora bulut",
			description: "qora bulut – black clouds ",
			title:
			  "Qora bulut, qora tuman, tongi yo‘q tunlar. (Habibiy) 	 ",
			text: "Qora bulutlar orasida qilichdek yaltirab chaqin chaqa boshladi.  (S. Ahmad, Jimjitlik) ",
		  },
		  {
			id: 45,
			name: "Qoramtir bulut",
			description: " qoramtir bulut– blackish cloud ",
			title:
			  "Qoramtir bulut. Qoramtir tutun. Chuqur jar tubida qoramtir anhor pishqirib, bo‘g‘iq sado taratib oqayotibdi. (H.G‘ulom, Mash'al) ",
			text: "Qoramtir bulutlar.. pag‘a-pag‘a bo‘lib, tez suzib ketdi. (H.Nazir, So‘nmas chaqmoqlar))",
		  },
		  {
			id: 46,
			name: "Qo'rg'oshindek bulut ",
			description: "qo'rg'oshindek bulut - leaden cloud",
			title: "Hozirgina yashnab turgan osmonni bir zumda qo‘rg‘oshindek bulut o‘raydi. Shatir-shutur yomg‘ir quyadi ",
			text: "(S. Ahmad, Ufq)",
		  },
		  {
			id: 47,
			name: "Ro'dapo bulut",
			description: "ro'dapo bulutlar-monstrous clouds",
			title:
			  "Ro‘dapo bulutlar, siyqa tangadek xira yaltirab turgan quyoshni yutib yuborishga  oshiqadi.  ",
			text: "(X. Sultonov, Onamning yurti)",
		  },
		  {
			id: 48,
			name: "Sersut bulut ",
			description: "sersut bulutlar- thunderclouds ",
			title:
			  "Qari gujumlarning xush salqinida Sajdaga bosh qo‘yar sersut bulutlar. ",
			text: "(Eshqobil Shukur, Hamal Ayvoni) ",
		  },
		  {
			id: 49,
			name: "Seryomg'ir bulut",
			description: " seryomg'ir bulut – rainy cloud",
			title:
			  "Bahorgi seryomg‘ir bulut.   ",
			text: "(Oʻzbek tilining izohli lugʻati, 1-jild)",
		  },
		  {
			id: 50,
			name: "Siyrak bulut ",
			description: " siyrak bulut – sparse cloud ",
			title:
			  "Shu vaqtda 	siyrak bulutlardan olashovur yomg‘ir quyib o‘tdi. (Oybek, Navoiy) 	 ",
			text: "Siyrak bulut. (Oʻzbek tilining izohli lugʻati, 3-jild)",
		  },
		  {
			id: 51,
			name: "Tanbal bulut",
			description: "tanbal bulut- lazy cloud",
			title:
			  "Mayliga, xotiri bugun jam, Bir tanbal bulutday uxlasin.  ",
			text: "Suvda ko‘rinmasa hayotdan bir iz, Kim uning bo‘yiga yo‘lni boshlardi.  (Halima Xudoyberdieva, Saylanma) ",
		  },
	...
	},
	{
	  ...
	  relatedWords: [
		...
		{
		  id: 30,
		  name: "Kelar-ketar (kelim-ketim) dunyo",
